...
-(void)handleNewsMessage:(NSNotification *)notification
{
    ...
    [dataDic setObject:fromOthers?recordMessage.bareJid.user:[XMPPManager sharedInstance].myJID.user forKey:@"strName"];
...
{
    [[XMPPManager sharedInstance] sendMessage:message to:_chatJID];

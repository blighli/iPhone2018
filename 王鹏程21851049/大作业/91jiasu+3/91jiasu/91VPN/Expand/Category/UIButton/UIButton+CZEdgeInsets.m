...
@implementation UIButton (CZEdgeInsets)
- (void)czButtonWithEdgeInsetsStyle:(CZEdgeInsetsStyle)style imageTitlespace:(CGFloat)space{
    ...
    switch (style) {
        case CZButtonEdgeInsetsStyleImageRight:
        {
            space = space * 0.5;
        ...
        case CZButtonEdgeInsetsStyleImageLeft:
        {
            space = space * 0.5;
            ...
            break;
        case CZButtonEdgeInsetsStyleImageBottom:
        {
            ...
            imageInsetsRight = - imageInsetsLeft+28;
            ...
            break;
        case CZButtonEdgeInsetsStyleImageTop:
        {
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);

...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        //设置背景颜色
        self.bgColor = [UIColor colorWithRed:2.0 green:222/255. blue:222/255. alpha:1];
...
- (void)drawRect:(CGRect)rect {
    ...
    //设置绘制蛇的填充颜色
    CGContextSetRGBFillColor(ctx, 0/255., 0/255., 0/255., 1);
...
- (void) addView {
    ...
    btn2.backgroundColor = [UIColor colorWithRed:0/255. green:0/255. blue:0/255. alpha:1];

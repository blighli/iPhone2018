...
+ (void)printCalendarOfYear:(NSInteger)year {
    ...
    NSLog(@"         一月                    二月                    三月");
    [XCCalendar printCalendarOfMonthFrom:1 to:3 inCalendarArray:calendarArr];
    NSLog(@"");
    NSLog(@"         四月                    五月                    六月");
    [XCCalendar printCalendarOfMonthFrom:4 to:6 inCalendarArray:calendarArr];
    NSLog(@"");
    NSLog(@"         七月                    八月                    九月");
    [XCCalendar printCalendarOfMonthFrom:7 to:9 inCalendarArray:calendarArr];
    NSLog(@"");
    NSLog(@"         十月                   十一月                   十二月");
    [XCCalendar printCalendarOfMonthFrom:10 to:12 inCalendarArray:calendarArr];
}
